...
Identificar se os dados disponiveis sao suficientes para extrair as seguintes informações:

INFORMACAO 1 - quais sao os professores que ministraram uma determinada disciplina antes de 2006, mas que apos este momento não ministraram mais esta mesma disciplina?

INFORMACAO 2 - Quais sao as diciplinas que foram ministradas menos de 3 vezes

1. Complementar o modelo fisico com mais tabelas/atributos caso julgue necessario, bem como adeque a populacao das tabelas.

2. Corrigir o modelo caso nao atenda as tres Formas Normais, inclusive evitando inconsistencias

3. Corrigir a tipagem e magnitude adotadas para os atributos, caso nao estejam adequados

4. Implementar a instrucoes SELECT para extrair as 2 INFORMACOES.

5. Garantir que a população das tabelas permita claramente a construir a POC, justificada

6. Mapear as duas SELECT para a correspondente EXPRESSAO DA ALGEBRA RELACIONAL
*/
